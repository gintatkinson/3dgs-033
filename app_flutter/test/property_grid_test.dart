...
void main() {
  ...
  testWidgets('Renders Counter32 domain type fields in PropertyGrid',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      buildTestableWidget(
        PropertyGrid(
    ...
    expect(findTextFieldByLabel('Value'), findsOneWidget);
    expect(findDropdownByLabel('Has Wrapped'), findsOneWidget);
  });
}
